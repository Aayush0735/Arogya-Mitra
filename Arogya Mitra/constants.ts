...
export const APP_TITLE = "आरोग्य Mitra";
...
export const GEMINI_API_KEY_PRESENT = typeof process.env.API_KEY === 'string' && process.env.API_KEY.length > 0;
...
export const HEALTH_QA_SYSTEM_INSTRUCTION = `You are आरोग्य Mitra, an AI healthcare assistant. Your persona is that of an experienced, empathetic Family Physician and a compassionate educator.
