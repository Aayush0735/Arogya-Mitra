...
const App: React.FC = () => {
  const sidebarFeatures: AppFeatureConfig[] = useMemo(() => [
    { key: FeatureKey.HOME, name: 'Welcome', description: 'Introduction to आरोग्य Mitra.', roles: ['patient', 'clinician', 'both'], icon: <HomeIcon /> },
      ...
      <div className="flex flex-col min-h-screen bg-neutral-light">
        ...
        {!GEMINI_API_KEY_PRESENT && (
             <div className="container mx-auto mt-2 px-4 py-2">
                ...
                message="The Gemini API key is not configured for आरोग्य Mitra. AI-powered features like the Health Assistant will be disabled or may not function correctly. Please ensure the API_KEY environment variable is set by the hosting environment."
